...
public class HashmapRetrievalControls : HashmapControls
{
    [Header("References")]
    ...
    public void OnSubmit()
    {
        ...
        m_Coroutine = StartCoroutine(OnRetrievalRoutine(keyPaper));
    ...
    IEnumerator OnRetrievalRoutine(Paper _key)
    {
        ...
        yield return m_Hashmap.Retrieve(key,
        ...
        Debug.Log("Retrieve Control Routine Finished");
        m_Coroutine = null;
        m_KeyOutline.OutlineColor = m_NormalColor;
        yield break;
    }
